...
# pylint: disable=C0103,C0301,R0913,R0917,R0903
# ruff: noqa: E501
...
class TestTSMixer:
    ...
    def test_forward_method_of_MixerLayer_with_valid_input(self):
        ...
        input_tensor = torch.randn(
            batch_size, num_features, num_time_steps, channels
        )

        # Create MixerLayer instance
        mixer_layer = MixerLayer(
            num_features,
            num_time_steps,
            hidden_dim=64,
            dropout_rate=0.2,
    ...
    def test_forward_method_of_TemporalProjection_with_valid_input(
        self,
    ):
    ...
    #
    def test_forward_method_of_TemporalProjection_with_empty_input(
        self,
    ):
        ...
        # Create TemporalProjection instance
        temporal_projection = TemporalProjection(
            num_features=10, num_time_steps=20
        )
    ...
    #
    def test_forward_method_of_TemporalProjection_with_NaN_input(
        self,
    ):
        ...
        # Create TemporalProjection instance
        temporal_projection = TemporalProjection(
            num_features=2, num_time_steps=2
        )
